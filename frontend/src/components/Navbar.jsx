    ...
    <header className={`nav-header ${scrolled ? "is-scrolled" : ""}`}>
      ...
      <div className="container nav-inner">
        ...
        <nav className="nav-links">
              ...
              <div className="mega-menu-inner">
                {categories.map((cat) => (
                  <div className="mega-col" key={cat.id}>
                    <Link to={`/shop/${cat.id}`} className="mega-col-title">
                      {cat.name}
                    </Link>
                ...
                <div className="mega-col mega-col-feature">
                  ...
                  <Link to="/shop?isNew=true" className="btn btn-outline btn-small">
                    Explore
                  </Link>
                </div>
              </div>
          ...
          <NavLink to="/shop?bestseller=true" className="nav-link">
            Bestsellers
          </NavLink>
        </nav>
        ...
        <div className="nav-actions">
          ...
          {user ? (
            <div className="nav-user">
              <Link to="/profile" className="nav-icon-btn" aria-label="My account">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
